...
const cueSets = { tr: [
  ...
  { start: 0.20, end: 5.00, type: 'chapter', title: 'ONE SENSOR, TWO VITAL READINGS', kicker: 'GLUCOSE AND KETONES, TOGETHER' },
  { start: 24.00, end: 30.00, type: 'key', title: 'CONTINUOUS TRENDS MAY PROVIDE AN EARLIER WARNING' },
  { start: 50.20, end: 55.00, type: 'chapter', title: 'PANDORA BEGINS SCIENCE', kicker: 'SEPARATING PLANET SIGNALS FROM STELLAR NOISE' },
  { start: 74.00, end: 80.00, type: 'key', title: 'CLEANER DATA CAN STRENGTHEN THE SEARCH FOR HABITABLE WORLDS' },
  { start: 100.20, end: 105.00, type: 'chapter', title: 'POSITRONS FOR A FUTURE COLLIDER', kicker: 'A CRITICAL INJECTOR TEST SUCCEEDS' },
  { start: 124.00, end: 130.00, type: 'key', title: 'A 15-TESLA MAGNET HELPS CAPTURE THE POSITRON BEAM' },
  { start: 150.20, end: 155.00, type: 'chapter', title: 'THE DOUBLE-HIGGS SEARCH', kicker: 'ATLAS AND CMS TIGHTEN THE LIMITS' },
  { start: 174.00, end: 180.00, type: 'key', title: 'ROUGHLY ONE PAIR FOR EVERY 1,500 SINGLE HIGGS BOSONS' },
  { start: 200.20, end: 205.00, type: 'chapter', title: 'AI, 6G AND SMART FACTORIES', kicker: 'CONNECTING ROBOTS, SENSORS AND PRODUCTION DATA' },
  { start: 224.00, end: 230.00, type: 'key', title: '6G COULD BECOME INFRASTRUCTURE FOR ADAPTIVE FACTORIES' },
  { start: 250.00, end: 260.00, type: 'cta', title: 'LIKE, SUBSCRIBE AND STAY CURIOUS' },
] };
