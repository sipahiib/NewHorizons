...
const cueSets = { tr: [
  ...
  { start: 0.15, end: 5.80, type: 'chapter', title: 'ROMAN OPENS A PANORAMIC WINDOW', kicker: 'NASA’S NEW SPACE TELESCOPE IS ON ITS WAY' },
  { start: 58.00, end: 65.00, type: 'key', title: 'ONE VIEW CAN COVER AT LEAST 100 TIMES HUBBLE’S AREA' },
  { start: 101.00, end: 108.00, type: 'key', title: 'ROMAN COULD REVEAL COLD AND FREE-FLOATING WORLDS' },
  { start: 120.20, end: 125.60, type: 'chapter', title: 'A NEW CLUE FOR ALPHA-GAL', kicker: 'RARE ANTIBODIES BLOCKED A KEY ALLERGIC SIGNAL IN THE LAB' },
  { start: 146.00, end: 153.00, type: 'key', title: 'PROMISING LAB RESULTS — NOT YET A PROVEN TREATMENT' },
  { start: 165.20, end: 170.60, type: 'chapter', title: 'ASTRA CROSSES A CYBER THRESHOLD', kicker: 'AI SECURITY CAPABILITY MEETS NEW SAFEGUARDS' },
  { start: 191.00, end: 198.00, type: 'key', title: 'CAPABILITY NOW DEPENDS ON ACCESS, CONTROL AND ACCOUNTABILITY' },
  { start: 210.20, end: 215.60, type: 'chapter', title: 'SAMBA’S FIERY FAREWELL', kicker: 'A TARGETED REENTRY RECORDED FROM THE AIR' },
  { start: 236.00, end: 243.00, type: 'key', title: 'REAL BREAKUP DATA CAN HELP FUTURE SATELLITES DISAPPEAR SAFELY' },
  { start: 255.20, end: 260.60, type: 'chapter', title: 'PALLAS-1 REACHES ORBIT', kicker: 'A NEW LIQUID-FUEL ROCKET PASSES ITS FIRST FLIGHT' },
  { start: 278.00, end: 285.00, type: 'key', title: 'THE NEXT TEST IS RELIABLE REUSE' },
  { start: 295.00, end: 305.00, type: 'cta', title: 'LIKE, SUBSCRIBE AND STAY CURIOUS' },
] };
