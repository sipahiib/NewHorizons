...
const cueSets = { tr: [
  ...
  { start: 0.20, end: 5.20, type: 'chapter', title: 'SPEECH + BODY LANGUAGE', kicker: 'UCSF · BRAIN–COMPUTER INTERFACE' },
  { start: 31.00, end: 37.00, type: 'key', title: '3 PARTICIPANTS · PROOF OF CONCEPT' },
  { start: 91.00, end: 98.00, type: 'key', title: 'WIRED SYSTEM · SURGERY REQUIRED' },
  { start: 120.20, end: 126.20, type: 'chapter', title: 'ROMAN’S PRIMARY INSTRUMENT IS ACTIVE', kicker: 'NASA · COMMISSIONING' },
  { start: 168.00, end: 175.00, type: 'key', title: 'COMMISSIONING — NOT A DISCOVERY' },
  { start: 180.20, end: 186.20, type: 'chapter', title: 'THE ROBOT CHECKS AGAIN', kicker: 'KAIST + ETRI · CoRe-VLN' },
  { start: 228.00, end: 235.00, type: 'key', title: 'BENCHMARK RESULT — NOT DEPLOYMENT' },
  { start: 240.20, end: 246.20, type: 'chapter', title: 'ONE CONTACT · TWO TRANSISTOR TYPES', kicker: 'ATOMICALLY THIN ELECTRONICS' },
  { start: 288.00, end: 295.00, type: 'key', title: 'LAB DEVICES — NOT A COMMERCIAL CHIP' },
  { start: 300.20, end: 306.20, type: 'chapter', title: 'A RETINAL CLUE TO HEART RHYTHM', kicker: 'UCL + MOORFIELDS' },
  { start: 348.00, end: 355.00, type: 'key', title: 'EYE SCAN ≠ AF DIAGNOSIS' },
