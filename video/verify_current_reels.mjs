...
const reports=[],tiles=[];
for(const [row,stem] of ['01-future-of-ai','02-planet-earth-ocean-acidification'].entries()){
 ...
 if(v.width!==1080||v.height!==1920||v.r_frame_rate!=='60/1'||v.codec_name!=='h264'||a.codec_name!=='aac'||duration<45||duration>50||speechEnd>45||duration-speechEnd>4.02)throw new Error(`Reel specification mismatch ${stem}: ${JSON.stringify({duration,speechEnd})}`);
 ...
 const sampleTimes=[2,8,15,22,29,36,43,duration-1];
