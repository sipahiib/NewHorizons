...
This file preserves the factual package, source links, claim limits, hook options and proposed visual candidates. Approval is recorded separately in `APPROVAL.md`; production constants are in `../../PRODUCTION_SPEC.md`.
